...
<form method='post'>
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo $this->formCheckbox("annotation_public[{$contribItem->id}]", null, array('checked'=>$contribItem->public) ); ?>
                </td>
                <td><?php echo $this->formCheckbox("annotation_anonymous[{$contribItem->id}]", null, array('checked'=>$contribItem->anonymous) ); ?>
                </td>                
