...
annotation_admin_header(array(__('Types')));
?>
...
<?php foreach ($annotation_types as $type): ?>
    <tr>
        <td><strong><?php echo metadata($type, 'display_name'); ?></strong></td>
        <td><?php  echo __($type->ItemType->name); ?></td>
        <td><a href="<?php echo url('items/browse/annotated/1/type/' . $type->item_type_id); ?>"><?php echo __("View"); ?></a></td>
