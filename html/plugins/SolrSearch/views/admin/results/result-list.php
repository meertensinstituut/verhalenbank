<?php foreach ($results->response->docs as $doc): ?>
  ...
  <div class="result">
    ...
    <div class="result-header">
      ...
      <!-- Record URL. -->
      <?php $url = SolrSearch_Helpers_View::getDocumentUrl($doc, "admin"); ?>
    ...
    <div class="editlinks">
        <ul style="margin: 0; padding: 0;">
            <li style="display: inline-block;">
                <a style="color:#80BFFF" href="<?php echo url('annotation/annotation/edit/id/' . $item->id); ?>"><?php echo __('Annotate'); ?></a>
            </li>
            &nbsp&middot&nbsp
            <li style="display: inline-block;">
                <a style="color:#80BFFF" href="<? echo url('annotation/clone/clone/id/' . $item->id);?>"><?php echo __('Clone'); ?></a>
            </li>
        </ul>
    </div>
